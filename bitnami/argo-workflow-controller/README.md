...
* [`3`, `3-scratch`, `3.3.9`, `3.3.9-scratch-r0`, `latest` (3/scratch/Dockerfile)](https://github.com/bitnami/containers/blob/main/bitnami/argo-workflow-controller/3/scratch/      Dockerfile)
