...
* [`2`, `2-scratch`, `2.4.6`, `2.4.6-scratch-r4`, `latest` (2/scratch/Dockerfile)](https://github.com/bitnami/containers/blob/main/bitnami/kubeapps-asset-syncer/2/scratch/Dockerfile)
