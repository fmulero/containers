...
* [`0`, `0-debian-11`, `0.15.0`, `0.15.0-debian-11-r11`, `latest` (0/debian-11/Dockerfile)](https://github.com/bitnami/containers/blob/main/bitnami/chartmuseum/0/debian-11/Dockerfile)
...
You can also do this with a minor change to the [`docker-compose.yml`](https://github.com/bitnami/containers/blob/main/bitnami/chartmuseum/docker-compose.yml) file present in this repository:
