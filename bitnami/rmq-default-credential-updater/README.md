...
- [`1`, `1-scratch`, `1.0.2`, `1.0.2-scratch-r7`, `latest` (1/scratch/Dockerfile)](https://github.com/bitnami/containers/blob/main/bitnami/rmq-default-credential-updater/1/scratch/Dockerfile)
